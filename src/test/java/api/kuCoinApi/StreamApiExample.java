...
public class StreamApiExample {
    ...
    public void sortHighToLow() {
        ...
        Assertions.assertEquals(top10.get(0).getSymbol(), "KARA-USDT");
    }

    @Test
    public void sortLowToHigh() {
        List<TickerData> lowToHigh = getTickers().stream().filter(x -> x.getSymbol().endsWith("USDT")).sorted(new TickerComparatorLow())
